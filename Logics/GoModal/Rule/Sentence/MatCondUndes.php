...
class GoModal_Rule_Sentence_MatCondUndes implements Rule
{
	public function apply( Branch $branch )
	{
		...
		$condNodes = GoModalBranch::getNodesByOperatorName( $branch->getUndesignatedNodes( true ), 'MATERIALCONDITIONAL' );
